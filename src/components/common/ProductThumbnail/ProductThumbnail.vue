    ...
    <div class="product-wrap mb-50">
      ...
      <div class="product-content text-center">
        ...
        <div class="yotpo yotpo-main-widget"
          :data-product-id="matchingVariant.sku"
          :data-price="matchingVariant.price.value.centAmount"
          :data-currency="matchingVariant.price.value.currencyCode"
          :data-name="currentProduct.name.replace(/[\”]/g, '')"
          :data-url="$router.resolve(productRoute(currentProduct.slug, matchingVariant.sku)).href"
          :data-image-url="displayedImageUrl(matchingVariant)">
        </div>
        <div class="yotpo bottomLine"
          :data-yotpo-product-id="matchingVariant.sku">
        </div>
